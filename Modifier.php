                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-warning">
                            <div class="card-header">
                               <center><h4 class="m-b-0 text-white" style="font-weight: bold;">Modifier un Patient</h4></center> 
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    echo "<input type='text' name='nom' class='form-control' value='$nom'>";
                                                    ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                   ...
                                                   <!-- <input type="text" name="prenom" class="form-control" placeholder="Prenom">-->
                                                    <?php
                                                    echo "<input type='text' name='prenom' class='form-control' value='$prenom'>";
                                                    ?>
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <!--<input type="text" name="tel" class="form-control" placeholder="06********">-->
                                                     <?php
                                                    echo "<input type='text' name='tel' class='form-control' value='$tel' >";
                                                    ?>
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                   ...
                                                   <?php
                                                    echo "<input type='text' name='cni' class='form-control' value='$cni' >";
                                                    ?>
                                                    </div>
                                            </div>
                                             <div class="col-md-12">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <?php
                                                    echo "<input type='text' name='adresse' class='form-control' value='$adresse' >";
                                                    ?>
