                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                               <center><h4 class="m-b-0 text-white" style="font-weight: bold;">Ajouter un Patient</h4></center> 
                            </div>
                            <div class="card-body">
                                <form action="AjouterClient.php" method="GET">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nom" class="form-control" placeholder="Hicham">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="prenom" class="form-control" placeholder="el kouria">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label" style="font-weight: bold;">Numéro Télèphone</label>
                                                    <input type="text" name="tel" class="form-control" placeholder="0620464168">
                                                    </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="adresse" class="form-control" placeholder="2 Rue Ernest Duvillard, ... ">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
