        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"  style="color: red;">Patient - Patient Management</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                         <div class="card-body">
                                <h4 class="card-title">Liste des Patients <a href="client.php" class='btn btn-success m-b-10 m-l-5' style="float: right;">Ajouter Patient</a></h4>
                                <h6 class="card-subtitle">Informations sur les patients</h6>
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                        $rep = $conn->query('select * from client');
                                        while ($data = $rep->fetch()) {
                                            ...
                                            echo "<td >$data[CNI]</td>";
                                            echo "<td> <a href='Modifier.php?id=$data[Id_Client]' class='btn btn-warning m-b-10 m-l-5' > Modifier </a> </td>";
                                            echo "<td> <a href='SupprimerClient.php?id=$data[Id_Client]' class='btn btn-danger m-b-10 m-l-5'>Supprimer</a></td>";
                                            echo "</tr>";
