                    ...
                    <ol class="breadcrumb">
                                    ...
                                    <ul class="dropdown-menu" style="width:400px;height:200px;overflow: scroll;">
                                    	<?php 
                                    		for($i=1; $i<=25; $i++)
                                    		{
                                    			echo "<li><a href='indexSoins.php?id=$i'>Semaine $i</a></li>";
                                    		}
                                    	?>
                                    </ul>
                                </div>
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	title:{
		text: "Soins intensifs"
	},	
	axisY: {
		title: "Number of Occupied Beds",
	...
	data: [{
		...
		showInLegend: true, 
		dataPoints:[
			{ y: <?php echo $ligne1[0]; ?>, label: "<?php echo 'lundi '; ?> " },
			{ y: <?php echo $ligne1[1]; ?>, label: "<?php echo 'mardi '; ?> " },
			{ y: <?php echo $ligne1[2]; ?>, label: "<?php echo 'mercredi '; ?> " },
			{ y: <?php echo $ligne1[3]; ?>, label: "<?php echo 'jeudi '; ?> " },
			{ y: <?php echo $ligne1[4]; ?>, label: "<?php echo 'vendredi '; ?> " },
			{ y: <?php echo $ligne1[5]; ?>, label: "<?php echo 'samedi '; ?> " },
			{ y: <?php echo $ligne1[6]; ?>, label: "<?php echo 'dimanche '; ?> " }
		]
	},
	{
		type: "column",	
		name: "total number of beds",
		legendText: "Free Beds",
		axisYType: "secondary",
		showInLegend: true,
		dataPoints:[
			{ y: <?php echo $ligne2[0]; ?>, label: "<?php echo 'lundi '; ?> " },
			{ y: <?php echo $ligne2[1]; ?>, label: "<?php echo 'mardi '; ?> " },
			{ y: <?php echo $ligne2[2]; ?>, label: "<?php echo 'mercredi '; ?> " },
			{ y: <?php echo $ligne2[3]; ?>, label: "<?php echo 'jeudi '; ?> " },
			{ y: <?php echo $ligne2[4]; ?>, label: "<?php echo 'vendredi '; ?> " },
			{ y: <?php echo $ligne2[5]; ?>, label: "<?php echo 'samedi '; ?> " },
			{ y: <?php echo $ligne2[6]; ?>, label: "<?php echo 'dimanche '; ?> " }
		]
	}]
});
chart.render();
